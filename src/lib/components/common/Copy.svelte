...
<div class="w-full bg-neutral-900/90 font-normal text-xs text-white rounded-lg shadow mt-2">
    ...
    <div class="p-4 pl-2 flex flex-row items-center justify-between">
        ...
        <button class="px-1" on:click={copyToClipboardSVGSwitching}
                type="button">
            <svg width="20" height="20" viewBox="0 0 24 24"
                 fill="none"
                 xmlns="http://www.w3.org/2000/svg"
                 class="text-gray-500 { textCopied ? 'hidden' : ''} transition ease-in-out duration-1000">
            ...
            <svg xmlns="http://www.w3.org/2000/svg"
                 viewBox="0 0 24 24"
                 width="20" height="20"
                 class="text-gray-500 { !textCopied ? 'hidden' : ''} transition ease-in-out">
