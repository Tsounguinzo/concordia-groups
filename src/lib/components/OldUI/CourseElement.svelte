...
<div class="col-span-12 sm:col-span-6 md:col-span-4 lg:col-span-3">
    <div class="transition-all rounded-lg group col-span-12 sm:col-span-6 md:col-span-4">
        <a class="flex flex-col w-full h-full p-3 text-center text-gray-100" href="/static"
           on:click|preventDefault={() => {
            ...
            <a class="flex items-center justify-center duration-1000 group-hover:-translate-y-1" on:click|preventDefault|stopPropagation={gotoCourseDescriptionURL} href="/static">
                More Info
