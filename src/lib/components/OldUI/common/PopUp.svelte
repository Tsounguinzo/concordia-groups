<script lang="ts">
    ...
    import Close from "$lib/components/OldUI/common/Close.svelte";
...
>
    ...
    >
        ...
        <Close class="absolute top-3 left-3" on:click={ () => isLinkPopUpModelOpen.set(false)}/>
            ...
            <div class="col-span-6 sm:col-span-6">
                ...
                >
                    <div class="inline-flex">
                        <Svg size={18} class="duration-300 ease-in group-hover:translate-x-6 group-hover:opacity-0">
                        ...
                        <Svg size={18}
                             class="duration-300 ease-in -translate-x-12 opacity-0 group-hover:-translate-x-4 group-hover:opacity-100">
